        ...
        if (length && length > 2 && data[0] == '4' && data[1] == '2') {
            ...
            if (s != "") {
                ...
                if (event == "telemetry") {
                    ...
                    // assign the size of the previous path
                    ...
                    if (lane==2) {
                        free_right = false; // car at rightmost lane
                    }
                    ...
                    for (int i = 0; i < sensor_fusion.size(); i++) {
                        ...
                        // lane of car
                        int check_car_lane = fabs(check_car_d/4); 
                        ...
                        // car ahead and close
                        if ((lowest_gap_center > 0) && (lowest_gap_center < 30)) {
                            too_close = true;
                        }
                        
                        // detected car is to the right
                        if ((lowest_gap_left_front < 30) || (lowest_gap_left_rear > -7)) {
                            free_left = false; // careful, can't change to left lane
                        }
                        
                        // detected car is to the right
                        if ((lowest_gap_right_front < 30) || (lowest_gap_right_rear > -7)) {
                   ...
                   // time to change lane
                    ...
                    //Craete a reference point. This might either be the car location or the last point of the prev path
                    double ref_x = car_x;
                    double ref_y = car_y;
                    double ref_yaw = deg2rad (car_yaw);
                    
                    if (prev_size < 2){
                        // The path is almost empty, use the car location as starting reference
                        // Create two points that represents two historical locations
                    ...
                    for (int i=0; i<ptsx.size();i++) {
                        // Here we need to transform the locations into local coordinates.
                        // That means the start point will be at 0,0
                        // and the angle will be at 0. Because in the car's perspective the car is heading straight
                        // So its a shift in rotation
                    ...
                    {
                        // move the points of the previous path to the next path planner
                        // this helps adding part of the previous path to the next one.
                        // This would end up making the path smoother.
                    ...
                    // find the y value of the x value we have and we find the target distance to the x point (30)
